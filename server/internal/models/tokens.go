...
func (o *Token) GetAppUser() *AppUser {
	if o == nil {
		return nil
	}
...
func (tokenL) LoadAppUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeToken any, mods queries.Applicator) error {
	var slice []*Token
	var object *Token
