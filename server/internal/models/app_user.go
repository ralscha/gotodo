...
func (o *AppUser) GetTodos() TodoSlice {
	if o == nil {
		return nil
	}
...
func (o *AppUser) GetTokens() TokenSlice {
	if o == nil {
		return nil
	}
...
var (
	...
	appUserColumnsWithoutDefault = []string{"email", "password_hash", "authority", "activated"}
	appUserColumnsWithDefault    = []string{"id", "email_new", "expired", "last_access"}
...
func (appUserL) LoadTodos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAppUser any, mods queries.Applicator) error {
	var slice []*AppUser
	var object *AppUser
	...
	query := NewQuery(
		qm.From(`todo`),
		qm.WhereIn(`todo.app_user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (appUserL) LoadTokens(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAppUser any, mods queries.Applicator) error {
	var slice []*AppUser
	var object *AppUser
	...
	query := NewQuery(
		qm.From(`tokens`),
		qm.WhereIn(`tokens.app_user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
